      ...
      <div className="pb-[3rem]">
        ...
        >
          ...
          <div className="max-w-[900px] ml-[-50px]  mt-[8rem] flex flex-col items-center text-left gap-8">
            <h1 className="text-[60px] ml-[-85px] font-bold leading-tight relative left-[-40px]">
            ...
            <form
              ...
              className="relative z-10 flex items-center w-[60%] bg-white rounded-full p-2 text-[20px] ml-[-130px] gap-3 "
            >
              <input
                value={input}
                ...
                className="flex text-[16px] outline-none border-none pl-2 text-black pr-[200px]"
              />
              <button
                type="submit"
                className="bg-[#4727ff] text-white text-[16px] px-6 py-2 rounded-full cursor-pointer"
              >
                Search
              </button>
            </form>
